...
public class FileUtil {
    ...
    public static void writeFile(String contenido,File file) {
        try {
    ...
    public void append(String contenido) {
        ...
        this.writeFile(cont + contenido,file);
    }

    public void guardar(byte[] contenido) {
        //Creando carpeta si no existe
        FileUtil.createFolder(file.getParentFile());
    ...
    public static boolean copyfile(String srFile, String dtFile) {
        try {
            ...
            System.err.println("FALLA, copiando archivo: " + srFile + " A " + dtFile);
            ex.printStackTrace();
        }
        return false;
    }
    ...
    public static InputStream getFileStreamFromResources(String resourceNameFile) {
        try {
            //InputStream in = Propiedad.class.//.getResourceAsStream("/com/edupro/properties/version.properties");
            ClassLoader classloader = Thread.currentThread().getContextClassLoader();
            InputStream is = classloader.getResourceAsStream(resourceNameFile);
            return is;
        } catch (Exception e) {
            e.printStackTrace();
        }
    ...
    public static String getFileStreamFromResourcesString(String resourceNameFile) {
        try {
            InputStream in = getFileStreamFromResources(resourceNameFile);
    ...
    public static void main(String[] args) {
        ...
        FileUtil.findFile(new File("./"), "Archivo", l);
        for (File file : l) {
